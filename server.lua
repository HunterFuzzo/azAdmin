...
ESX.RegisterServerCallback('azAdmin:getUsergroup', function(source, cb)
...
ESX.RegisterServerCallback('azAdmin:getAllItems', function(source, cb)
  cb(items)
end)


ESX.RegisterServerCallback("azAdmin:getAllJobs", function(source, cb)
  local allJobs = {}
...
ESX.RegisterServerCallback("azAdmin:getAllGrade", function(source, cb, jobName)
  local gradeJobs = {}
...
RegisterServerEvent("azAdmin:GiveCash")
AddEventHandler("azAdmin:GiveCash", function(money)
...
RegisterServerEvent("azAdmin:GiveBanque")
AddEventHandler("azAdmin:GiveBanque", function(money)
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)
    local total = money
...
RegisterNetEvent("azAdmin:giveItem")
AddEventHandler("azAdmin:giveItem", function(target, itemName, qty)
    local source = source
...
RegisterServerEvent("azAdmin:GiveND")
AddEventHandler("azAdmin:GiveND", function(money)
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)
    local total = money
...
RegisterServerEvent('azAdmin:kickjoueur')
AddEventHandler('azAdmin:kickjoueur', function(player, raison)
    local steam
...
RegisterNetEvent("azAdmin:addreport")
AddEventHandler("azAdmin:addreport", function(raison)
  local _src = source
  local xPlayer = ESX.GetPlayerFromId(_src)
    ...
    TriggerClientEvent("azAdmin:sendNotifForReport", -1, 1)
end)


ESX.RegisterServerCallback('azAdmin:getAllReport', function(source, cb)
  cb(allReport)
end)

ESX.RegisterServerCallback('azAdmin:deleteItem', function(source, cb, item, count)
  local xPlayer = ESX.GetPlayerFromId(source)
  xPlayer.removeInventoryItem(item, count)
  cb()
end)

RegisterServerEvent("azAdmin:closeReport")
AddEventHandler("azAdmin:closeReport", function(nomMec, raisonMec)
    TriggerClientEvent("azAdmin:sendNotifForReport", -1, 2, nomMec, raisonMec)
